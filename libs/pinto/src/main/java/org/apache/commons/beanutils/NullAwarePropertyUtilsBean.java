 ...
 * @author Erik Meade
 * @version $Revision: 822777 $ $Date: 2009-10-07 17:23:23 +0200 (Wed, 07 Oct 2009) $
 * @see Resolver
 * @see PropertyUtils
 * @since 1.7
 */

public class NullAwarePropertyUtilsBean extends PropertyUtilsBean{
     ...
     * @return The PropertyUtils bean instance
     */
    public static NullAwarePropertyUtilsBean getInstance() {
        return (NullAwarePropertyUtilsBean) BeanUtilsBean.getInstance().getPropertyUtils();
    }
    ...
    /** Base constructor */
    public NullAwarePropertyUtilsBean() {
    ...
    private Object invokeMethod(
        ...
        try {
            //System.out.println("Method: "+method+" - Bean: "+bean+" - values: "+values);
