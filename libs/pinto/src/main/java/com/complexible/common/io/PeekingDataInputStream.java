...
/**
 * <p>A {@link java.io.DataInputStream} that supports peeking at the next byte in the stream.</p>
 *
...
public class PeekingDataInputStream extends DataInputStream {
    ...
    public PeekingDataInputStream(final InputStream theStream) {
        // wrapping in BufferedInputStream guarantees that mark/reset in peek will work
        super(theStream instanceof BufferedInputStream
