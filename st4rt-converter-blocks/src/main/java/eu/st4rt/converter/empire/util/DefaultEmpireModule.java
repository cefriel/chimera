...
import eu.st4rt.converter.empire.config.io.impl.PropertiesConfigReader;
import eu.st4rt.converter.empire.config.io.impl.XmlConfigReader;
import eu.st4rt.converter.empire.ds.DataSourceFactory;
import eu.st4rt.converter.empire.ds.impl.SparqlEndpointSourceFactory;
import eu.st4rt.converter.empire.spi.Instrumentor;
import eu.st4rt.converter.empire.spi.guice.PersistenceInjectionModule;
...
public final class DefaultEmpireModule extends AbstractModule implements EmpireModule {
	...
	public static EmpireConfiguration readConfiguration() {
		...
		try {
			...
			InputStream configResource = Empire.class.getClassLoader().getResourceAsStream(System.getProperty("empire.configuration.file"));
			//It2Rail: read config from class loader to support Empire running as Web application
			if (System.getProperty("empire.configuration.file") != null && configResource!= null) {
				aConfigStream = configResource;
			}
