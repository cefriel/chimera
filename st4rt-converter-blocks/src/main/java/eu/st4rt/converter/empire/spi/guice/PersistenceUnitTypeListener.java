...
/**
 * <p>Implementation of the Guice TypeListener interface for marking fields as candidates for injection if they
 * are annotated with the {@link PersistenceUnit} annotations.</p>
 *
