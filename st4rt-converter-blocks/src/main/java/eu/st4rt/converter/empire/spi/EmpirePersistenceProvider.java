...
package eu.st4rt.converter.empire.spi;
...
import eu.st4rt.converter.empire.impl.EntityManagerFactoryImpl;
...
public final class EmpirePersistenceProvider implements PersistenceProvider {
	 ...
	 * @throws empire.ds.DataSourceException if there is an error while creating the data source
	 */
