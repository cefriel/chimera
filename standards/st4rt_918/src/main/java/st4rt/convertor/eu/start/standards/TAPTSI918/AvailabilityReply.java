 ...
 *         &lt;choice maxOccurs="2">
 *           &lt;element name="Availability" type="{http://www.uic-asso.fr/xml/passenger/reservation/01}AvailabilityType"/>
...
@XmlType(name = "", propOrder = {
    "requestor",
    "dialogue",
    "availabilityOrNegativeReply"
})
@XmlRootElement(name = "AvailabilityReply")
public class AvailabilityReply {
    ...
    @XmlElements({
        @XmlElement(name = "Availability", type = AvailabilityType.class),
        @XmlElement(name = "NegativeReply", type = NegativeReplyType.class)
    })
    protected List<Object> availabilityOrNegativeReply;
    ...
    /**
     * Gets the value of the availabilityOrNegativeReply property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the availabilityOrNegativeReply property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAvailabilityOrNegativeReply().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getAvailabilityOrNegativeReply() {
        if (availabilityOrNegativeReply == null) {
            availabilityOrNegativeReply = new ArrayList<Object>();
        }
        return this.availabilityOrNegativeReply;
    }
