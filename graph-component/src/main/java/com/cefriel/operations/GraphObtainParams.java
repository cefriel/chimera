...
record GraphObtainParams (String namedGraph, String baseIri, String rdfFormat, Boolean defaultGraph,
    ...
    public GraphObtainParams mergeHeaderParams(GraphObtainHeaderParams headerParams, GraphObtainParams graphObtainParams) {
    ...
    public static GraphObtainHeaderParams getGraphObtainHeaderParams(Exchange e) {
    ...
    public static GraphObtainParams exchangeToGraphObtainParams(GraphBean baseConfig) {
        return new GraphObtainParams(
    ...
    public static Boolean isNativeRDFGraph (GraphObtainParams params) {
        return params.pathDataDir != null;
    }
    public static Boolean isInferenceRDFGraph (GraphObtainParams params) {
        return (params.ontologyPaths != null) &&
                (params.ontologyPaths.size() > 0) &&
                (params.rdfFormat != null);
    }

    public static Boolean isHTTPRDFGraph (GraphObtainParams params) {
        return params.serverURL != null &&
                params.repositoryId != null;
    }

    public static Boolean isSPARQLEndpointGraph (GraphObtainParams params) {
        return params.sparqlEndpoint != null;
    }

    // todo refactor and reuse the repo population functionality of the GraphAdd operation
    public static void populateRepository(Repository repo, Exchange exchange, String namedGraph, List<String> ontologyPaths, String jwtToken) throws IOException {
    ...
    public static Repository createSchemaRepository(Exchange exchange, String namedGraph, List<String> ontologyPaths, String jwtToken) throws IOException {
    ...
    private record RDFGraphAndExchange (RDFGraph graph, Exchange exchange) {}
