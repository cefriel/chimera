...
public abstract class SemanticLoader implements Processor {
    protected Model load_data(String url) throws RDFParseException, RDFHandlerException, IOException {
        ...
        if (url.startsWith("classpath://")){
        	...
        	rdfParser.parse(this.getClass().getClassLoader().getResourceAsStream(url),url);
        	return model;
        }
